...
@AllArgsConstructor
public class GamesSteps extends SpringIntegrationTest {
    ...
    public void iHavePlayedGames(){
        ...
        PlayingCard playedCard1 = new PlayingCard(3, CardSuit.SPADES);
        PlayingCard playedCard2 = new PlayingCard(4, CardSuit.DIAMONDS);
